    ...
    <div class="connect">
       ...
       <el-table
            ...
            <template slot-scope="scope">
                ...
                size="mini"
                type="danger"
                @click="connectDevice(scope.row)">连接</el-button>
            </template>
            </el-table-column>
      </el-table>
      ...
      <el-table
            ...
            <template slot-scope="scope">
                ...
                size="mini"
                type="danger"
                @click="disconnectDevice(scope.row,scope.$index)">断开连接</el-button>
            </template>
            </el-table-column>
      </el-table>
    </div>
  ...
  data: function () {
    return {
      ...
      devRule:{
        ...
        multicast:[
          { required: true, pattern:/^((25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\.){3}(25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)$/ ,message:'请输入组播地址', trigger: 'change' }
        ]
      }
    }
  },
