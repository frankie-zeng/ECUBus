...
typedef struct
{
    ...
    *           STREAMING USAGE: Used in all steps.*/
    ...
    /** @brief   INPUT: Initialization Vector length. Ignored for NULL & ECB cipher block modes.
     *                  - Must be the block length corresponding to the block mode. <br>
     *           STREAMING USAGE: Used in START. */
    uint32_t         ivLength;
...
typedef struct
{
    ...
    /** @brief   INPUT: The XTS Tweak key. <br>
