...
*
*   @addtogroup hse_srv_crc32 HSE CRC service
*   @ingroup class_crypto_services
*   @{
*/
/*==================================================================================================
*
*   (c) Copyright 2019-2020 NXP.
*
...
#define HSE_CRC32_MODE_DONT_OUTPUT_COMP         ((hseCrc32Mode_t)0x00000300U)   /**< @brief The output is not complimented (xored with all-ones) (the difference between with- and without- this flag is equivalent \
                                                                                  *         to xor of the output with all-ones).*/
#define HSE_CRC32_MODE_INITIAL_VALUE_ZERO       ((hseCrc32Mode_t)0x00000400U)   /**< @brief The initial crc value is 0 instead of all-ones. */
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/
...
typedef struct
{
     ...
     *                    crcOperation = HSE_CRC32_ALGO_IEEE_802 | HSE_CRC32_ALGO_DONT_INPUT_SWAP | HSE_CRC32_ALGO_DONT_OUTPUT_COMP; */
    uint32_t       crcOpMode;
