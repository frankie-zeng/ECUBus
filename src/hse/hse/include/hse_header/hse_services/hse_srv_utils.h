...
typedef struct
{
     ...
     *                  the same MU Interface. Otherwise an HSE_SRV_RSP_INVALID_MU_CHANNEL error will be reported. */
...
* NOTE:     
*           - After a successful erase operation. HSE will enter in Shut Down mode and a system reset is required. 
*/
